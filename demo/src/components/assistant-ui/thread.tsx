...
export type ThreadComponents = {
  ...
  ComposerBefore?: ComponentType | undefined;
  ComposerAfter?: ComponentType | undefined;
  ComposerReplacement?: ComponentType | undefined;
      ...
      >
        <div className="mx-auto flex w-full max-w-(--thread-max-width) flex-1 flex-col px-4 pt-4">
          ...
          <ThreadPrimitive.ViewportFooter className="aui-thread-viewport-footer bg-background sticky bottom-0 mt-auto flex flex-col gap-4 overflow-visible rounded-t-(--composer-radius) pb-4 md:pb-6">
            ...
            {ComposerBefore ? <ComposerBefore /> : null}
            {ComposerReplacement ? <ComposerReplacement /> : <Composer />}
            {ComposerAfter ? <ComposerAfter /> : null}
...
const Composer: FC = () => {
  const { composerPlaceholder, composerDisabled } = useContext(ThreadComponentsContext);
  return (
