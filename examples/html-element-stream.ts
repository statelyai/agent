...
const events = defineEvents({
    ...
    "element.input.select": z.object({
        options: z.array(z.string()),
        selected: z.string()
    }).merge(inputProperties),
    "element.input.textarea": inputProperties,
    "element.input.checkbox": z.object({
        checked: z.boolean()
    }).merge(inputProperties),
    "element.input.radio": z.object({
        options: z.array(z.string()),
        selected: z.string()
    }).merge(inputProperties),
