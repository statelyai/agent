/**
 * The state-machine "brain" both Eve tools bridge to. The machine owns
 * legality and state; the Eve LLM agent just converses and calls the tools.
 *
 ...
 * fold the result into a JSON-safe `ToolResult`. The Eve tools (tools/*.ts) are
