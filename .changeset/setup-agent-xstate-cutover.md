...
- Add `machine.getTasks(...)`, `machine.execute(...)`, `getAgentEffects(...)`, `doneEvent(...)`, and `transitionResult(...)` for pure XState transition loops where the host/framework owns execution.
